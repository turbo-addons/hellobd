...
Route::prefix('frontend')->group(function () {
    ...
    Route::get('/home-header', [\App\Http\Controllers\Api\FrontendApiController::class, 'homeOne']);
    ...
    Route::get('/push/stats', [PushNotificationController::class, 'getStats']);
...
Route::middleware(['auth:sanctum'])->prefix('v1')->group(function () {
    ...
    Route::post('push/send-test', [PushNotificationController::class, 'sendTestNotification'])->name('api.push.send-test');
    Route::post('push/send-breaking-news', [\App\Http\Controllers\Admin\PushNotificationAdminController::class, 'sendBreakingNews'])->name('api.push.send-breaking-news');
    Route::get('push/admin-stats', [\App\Http\Controllers\Admin\PushNotificationAdminController::class, 'getStats'])->name('api.push.admin-stats');
});
