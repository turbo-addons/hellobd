...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'TermActionHook' => App\Enums\Hooks\TermActionHook::class,
        'SettingFilterHook' => App\Enums\Hooks\SettingFilterHook::class,
        'SettingActionHook' => App\Enums\Hooks\SettingActionHook::class,
        'ModuleFilterHook' => App\Enums\Hooks\ModuleFilterHook::class,
        'ModuleActionHook' => App\Enums\Hooks\ModuleActionHook::class,
        'CommonFilterHook' => App\Enums\Hooks\CommonFilterHook::class,
        'ContentActionHook' => App\Enums\Hooks\ContentActionHook::class,
        'PermissionFilterHook' => App\Enums\Hooks\PermissionFilterHook::class,
        'PermissionActionHook' => App\Enums\Hooks\PermissionActionHook::class,
        'EmailFilterHook' => App\Enums\Hooks\EmailFilterHook::class,
        'EmailActionHook' => App\Enums\Hooks\EmailActionHook::class,
        'NotificationFilterHook' => App\Enums\Hooks\NotificationFilterHook::class,
        'NotificationActionHook' => App\Enums\Hooks\NotificationActionHook::class,
        'MediaFilterHook' => App\Enums\Hooks\MediaFilterHook::class,
        'MediaActionHook' => App\Enums\Hooks\MediaActionHook::class,
        'ActionLogFilterHook' => App\Enums\Hooks\ActionLogFilterHook::class,
    ],
];
